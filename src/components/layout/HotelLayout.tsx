...
// ----------------------------------------
const navItems = [
    { to: '/hotel', icon: <DashboardIcon />, label: 'Dashboard', end: true },
    { to: '/hotel/bookings', icon: <BookingsIcon />, label: 'Bookings' },
    { to: '/hotel/live', icon: <LiveIcon />, label: 'Live Monitor' },
    { to: '/hotel/sitters', icon: <SittersIcon />, label: 'Sitters' },
    { to: '/hotel/reports', icon: <ReportsIcon />, label: 'Reports' },
    { to: '/hotel/safety', icon: <SafetyIcon />, label: 'Safety Record' },
    { to: '/hotel/settings', icon: <SettingsIcon />, label: 'Settings' },
];
